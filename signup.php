  ...
  <body>
    ...
    if($showAlert){
        ...
        <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Success</strong> You account is now created , now you can login.
    ...
    <form action="/loginsystem/signup.php" method="post">
        ...
        <div class="form-group ">
            ...
            <small id="emailHelp" class="form-text text-muted">Make cure you type the same password.</small>
        </div>
